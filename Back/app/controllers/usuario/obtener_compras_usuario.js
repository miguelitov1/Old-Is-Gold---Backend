...
async function obtenerComprasUsuario(req, res) {
  try {
    const { idUsuario } = req.params;
    await schema.validateAsync(parseInt(idUsuario));

    const ventas = await repositorioUsuarios.obtenerComprasUsuario(idUsuario);
...
module.exports = obtenerComprasUsuario;
